...
void CPU6502::atestandsetNZ() {
    setNZ(a);
}

void CPU6502::xtestandsetNZ() {
    setNZ(x);
}

void CPU6502::ytestandsetNZ() {
    setNZ(y);
}
...
void CPU6502::cmd6502nop1a() {
    numofcycles += 2;
}

void CPU6502::cmd6502nop3a() {
    numofcycles += 2;
}

void CPU6502::cmd6502nop5a() {
    numofcycles += 2;
}

void CPU6502::cmd6502nop7a() {
    numofcycles += 2;
}

void CPU6502::cmd6502nopda() {
    numofcycles += 2;
}

void CPU6502::cmd6502nopfa() {
    numofcycles += 2;
}
